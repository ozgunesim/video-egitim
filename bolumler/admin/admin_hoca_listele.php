...
$bekleyen_egitmen = $db->bekleyen_hoca_listesi_getir($sayfa,$aralik);	//onay bekleyen egitmen kayıtları veritabanından cekiliyor
...
<div class="table-responsive">
	...
	<?php
	if($bekleyen_egitmen){
		foreach ($bekleyen_egitmen as $satir) {				//onay bekleyen egitmenlerin bilgileri tablolanıyor
			echo "<tr>";
				...
				"</td>";
			echo "</tr>";	//onayla ve reddet butonları yazdırılıyor
		}
	}
	?>
	</table>
